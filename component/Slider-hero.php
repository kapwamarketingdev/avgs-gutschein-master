                        ...
                        <div class="row">
                            <div class="col-xl-8 col-lg-7 col-md-8">
                                <div class="hero__caption">
                                    ...
                                    <h1 data-animation="fadeInLeft" data-delay=".5s"><strong style ="color:red;">AVGS </strong>-Gutschein</h1>
                                    ...
                                    <div class="hero__btn" data-animation="fadeInLeft" data-delay="1.1s">
                                        <a href="industries.html" class="btn hero-btn">Kontakt Us</a>
                                    </div>
                                </div>
                            </div>
                        </div>
